...
public class _index__jsp extends com.caucho.jsp.JavaPage
{
  				...
  				@Override public List creationDBTIndices(TL tl){
  					return Util.lst(
  									...
  									,Util.lst(Util.lst("unique key (",C.jsonRef,Util.lst(C.path,64))
  									   ...
  									   `path` text not null,
  									   `typ` enum( 'Int' , 'dbl' , 'str' , 'bool' , 'dt' , 'jsonRef', \u00e2\u0080\u0098javaObjectDataStream\u00e2\u0080\u0099	) not null, --	, \u00e2\u0080\u0098file\u00e2\u0080\u0099 ,'function','codeJson','javaMap'
  									   `json` blob ,
  									   ...
  									   `path` text ,
  									   `json` blob ,
  									   `act` enum(\u00e2\u0080\u0098insert\u00e2\u0080\u0099 ,\u00e2\u0080\u0099update\u00e2\u0080\u0099 ,\u00e2\u0080\u0099delete\u00e2\u0080\u0099 ,\u00e2\u0080\u0099login\u00e2\u0080\u0099 ,\u00e2\u0080\u0099logout\u00e2\u0080\u0099) ,
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("EU059S/index.jsp"), -4084240360805846946L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
}
